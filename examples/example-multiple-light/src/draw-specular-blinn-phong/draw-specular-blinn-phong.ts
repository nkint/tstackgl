...
import vert from './specular-blinn-phong.vert'
import frag from './specular-blinn-phong.frag'
...
export type PropsSpecularBlinnPhong = PropsGeometry & PropsLight

//------------------------------------------- uniforms

interface Uniforms extends PropsSpecularBlinnPhong {}
...
export function createSpecularBlinnPhong(regl: createRegl.Regl, mesh: Mesh) {
  const draw = regl<Uniforms, Attributes, PropsSpecularBlinnPhong>({
    vert,
    frag,

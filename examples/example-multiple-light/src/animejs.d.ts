...
type AnimeCallbackFunction = (anim: animejs.AnimeInstance) => void
...
declare namespace animejs {
  ...
  // Timeline
  function timeline(
    params?: AnimeParams, //| AnimeInstanceParams | ReadonlyArray<AnimeInstance>,
  ): AnimeTimelineInstance
  function random(min: number, max: number): number
}

declare function animejs(params: animejs.AnimeParams): animejs.AnimeInstance

declare module 'animejs' {
  export = animejs
  // export as namespace animejs
}
